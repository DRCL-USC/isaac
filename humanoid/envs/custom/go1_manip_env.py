...
import torch
from humanoid.envs.base.legged_robot_manip import LeggedRobotManip

from humanoid.utils.terrain import  HumanoidTerrain


class Go1FreeEnv(LeggedRobotManip):
    '''
    ...
    def _get_noise_scale_vec(self, cfg):
        ...
        noise_vec[42: 46] = noise_scales.quat * self.obs_scales.quat         # euler x,y
        return noise_vec
    ...
    def compute_observations(self):
        ...
        if self.cfg.terrain.measure_heights:
            heights = torch.clip(self.root_states[self.robot_actor_idxs, 2].unsqueeze(1) - 0.5 - self.measured_heights, -1, 1.) * self.obs_scales.height_measurements
...
#
    def _reward_default_joint_pos(self):
        ...
        return - 0.05 * torch.norm(joint_diff, dim=1)
...
#
    def _reward_base_height(self):
        ...
        base_height = torch.mean(self.root_states[self.robot_actor_idxs, 2].unsqueeze(1) - self.measured_heights, dim=1)
