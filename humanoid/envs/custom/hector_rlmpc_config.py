...
class HectorMPCCfg(LeggedRobotCfg):
    """
...
class HectorMPCCfgPPO(LeggedRobotCfgPPO):
    seed = 5
    ...
    class commands:
        ...
        ranges = {
            ...
            'pitch': [-0.4, 0.4],
            'yaw': [-0.8, 0.8],
            'local_pos_x': [-0.5, 0.5],   # Local position offset from current
            'local_pos_y': [-0.3, 0.3], 
            'local_pos_z': [0.45, 0.65],  # Desired height
            'ang_vel_x': [-1.0, 1.0],
            'ang_vel_y': [-1.0, 1.0],
            'ang_vel_z': [-1.0, 1.0],
            'lin_vel_x': [-0.8, 0.8],
